...
TEACHER PROMPTS for annotating code printouts for livecoding plans:
...
-  `CLARIFY` :: point where clarification likely necessary
-  `XTRA` :: avenues for further exploration, related links or app/site names, higher-end differentiation materials, etc.
